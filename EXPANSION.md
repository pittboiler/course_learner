...
**Status (2026-09-11): 12 of 16 built.** Done: `programming-foundations` (15), `algorithms` (20),
...
at Jacob's request; see the revision note in its syllabus). Remaining, all with prerequisites already
built so none is blocked: `programming-languages` (21), `computational-complexity` (18),
