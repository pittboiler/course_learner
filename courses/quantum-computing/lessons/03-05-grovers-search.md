...
![Left: a quarter-circle diagram with a horizontal axis labelled ket unmarked and a vertical axis labelled ket marked. A blue arrow at 30 degrees is labelled start, ket s, angle theta. A dashed orange arrow at minus 30 degrees is labelled after oracle, reflected. A red arrow at 90 degrees is labelled after diffusion, 3 theta, with a red arc marking the plus 2 theta rotation. Captions read that one Grover iteration equals two reflections equals a rotation by 2 theta, and that sine theta equals the square root of M over N, so theta is about 1 over root N and you need about pi over 4 times root N turns. Right: three groups of eight amplitude bars for N equals 8 with one marked item shown in red, labelled k equals 0 with probability 0.12, k equals 1 with probability 0.78, and k equals 2 with probability 0.95, showing the marked bar growing while the other seven shrink.](assets/03-05-fig1.svg)
