...
- **Sideways (micro):** the increasing-returns / natural-monopoly / marginal-cost-pricing tension is core industrial organization — see `](../../grad-micro/syllabus.md)` on increasing returns and monopoly pricing. The "invention has a fixed cost, copying is free" structure is the canonical public-good / non-excludability problem.
