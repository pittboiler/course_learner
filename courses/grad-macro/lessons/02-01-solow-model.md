...
(This is a textbook 1-D autonomous ODE with a single stable fixed point — see the phase-line reasoning in [`dynamical-systems`](../../dynamical-systems/syllabus.md). The sign of $\dot k$ on each side of $k^*$ is exactly the phase-line arrow diagram.)
